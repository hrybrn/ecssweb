...
if($voting){
  ...
  //youtube embed
  echo '<iframe width="720" height="405" src="https://www.youtube.com/embed/videoseries?list=PL7QE45LzlPZ65c4kAAtPLqxWwQCIl5emz" frameborder="0" allowfullscreen></iframe>';
  echo "
		<script>
			var first = '" . $first . "';
		</script>
