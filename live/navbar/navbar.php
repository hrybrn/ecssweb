        ...
        if(is_array($address)){
             $nav .= 
                '
                 ...
                 <div id="navButton" onclick="location.href=\''. $relPath . $address['default'] . '?lang=' . $lang . '\'">' . $name . '</div>
                </form> 
            ...
            $nav .= 
                '<a><div id="navButton" onclick="location.href=\''. $relPath . $address . '?lang=' . $lang . '\'">' . $name . '</div></a>'; 
        }
