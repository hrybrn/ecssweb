...
<head>
    ...
    setTextDomain('title');
    ?>
    <title><?= $hackathonEvent->hackathonEventName ?> Individual Management | ECSS</title>
...
<div id='formDiv'>
    <h3><?= $hackathonEvent->hackathonEventName ?> Individual Management Page</h3>
    ...
    <table>
        <tr>
            ...
            <td>
                <input type='text' id='name' value='<?= $person->hackathonPersonName ?>'></input>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type='text' id='course' value='<?= $person->hackathonPersonCourse ?>'></input>
            </td>
        </tr>
        <tr>
            <td>
...
<script src="/hackathon/person/manage/manage.js"></script>
<script>
...
<div id='formDiv'>
    ...
    <p>You need to sign up <b>before</b> you can manage your individual information.</p>
