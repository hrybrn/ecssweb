...
$time = $time->format('H:i:s dS M Y');
$hash = hash('sha256', $time . $team->id);

$sql = "INSERT INTO hackathonHash(hackathonHash, hackathonTeamID, hackathonHashExpired, hackathonHashDate)
        VALUES(:hashVal, :teamID, 0, :hashTime);";
...
echo json_encode(['status' => true, 'message' => 'Token generated.']);