...
//team member kicks self
if($email == $userInfo['email']){
    echo json_encode(['status' => false, 'message' => 'You cannot kick yourself.']);
    exit;
}

$sql = "UPDATE hackathonPerson SET hackathonTeamID = NULL
        WHERE hackathonPersonEmail = :email AND hackathonTeamID = :teamID;";
