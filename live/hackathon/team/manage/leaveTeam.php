...
$sql = "UPDATE hackathonPerson SET hackathonTeamID = NULL WHERE hackathonTeamID = :teamID AND hackathonPersonEmail = :email;";
$statement = $db->prepare($sql);
$params = [':teamID' => $team->id, ':email' => $userInfo['email']];
